...
import FourthGeometryRecommended from './FourthGeometryRecommended';
import BarChart from '../Charts/BarChart';


function FourthGeometryRecommended2() {


//useState
    const [lineVoltage, setLineVoltage] = useState(110*1000)
    const [conductorMaterial, setConductorMaterial] = useState('ACSR Goat');
    const [windPressure, setWindPressure] = useState(48.23); //should be taken from user
    const [sizeOfPhaseConductor, setSizeOfPhaseConductor] = useState('30/7/3.71 mm');
    ...
    const [overAllDiameter, setOverAllDiameter] = useState(25.97*0.001);
    const [eachDiameter, setEachDiameter] = useState(3.71); //mm
    const [weight, setWeight] = useState(1489);
    const [ultimateStrength, setUltimateStrength] = useState(135.8*1000)

    console.log(lineVoltage)
    console.log("overAll diameter", overAllDiameter)
          ...
          <div className="chart__section">
                ...
                <div className="geometry__chart">
                    ...
                    <div style={{height: "800px", width: "400px", marginLeft: "80px", marginRight: "170px"}}>
                        <BarChart title1="30/7/3 Panther" title2="" value1="92.08" value2="" title="Original Transmission Line" ylabel="Efficiency"/>
                    </div>
                    <div style={{height: "800px", width: "400px"}}>
                        <BarChart title1="30/7/3.71 Goat" title2="" value1="94.676" value2="" title="Our Recommendation" ylabel="Efficiency"/>
                    </div>
            </div>
          </div>
      </div>
...
export default FourthGeometryRecommended2