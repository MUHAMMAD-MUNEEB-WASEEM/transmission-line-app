...
import './FourthGeometry.module.css';
import math, {
    ...
    return (
      <div className="geometry">
        <div className="topbar">
          <h1 className="param__heading">Transmission Line Parameters</h1>
          </div>
          <div className="routes">
            <h2 className="heading"><Link className="effect-1" to="/fourthgeometry/recommendation1">Recommendation 1</Link></h2>
            <h2 className="heading"><Link className="effect-1" to="/fourthgeometry/recommendation2">Recommendation 2</Link></h2>
          </div>
          ...
          <div className="sides">
            <div className="geometry__content">
              ...
              <h4>Line Voltage: <span className="answer">{lineVoltage} V</span> </h4>
                  ...
                  <h4>Span:  <input value={span} onChange={e => setSpan(e.target.value)} placeholder="Enter Span" type="number"/> m <br/>(180-220 m)</h4>
                  <br/>
